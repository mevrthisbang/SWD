            ...
            <div class="container" style="margin-top: 50px;">
                ...
                <form action="${updateActionLink}" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputName" value="${requestScope.PRODUCT.name}" name="txtName" <c:if test="${requestScope.PRODUCT.status eq 'Inactive'}">readonly="true"</c:if> />
                                    <font color="red">
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputPrice" value="${requestScope.PRODUCT.price}" name="txtPrice" <c:if test="${requestScope.PRODUCT.status eq 'Inactive'}">readonly="true"</c:if>/>
                                    <font color="red">
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="file" onchange="readURL(this);" accept="image/*" name="imgFood" class="form-control-file" id="inputImg" value="${requestScope.PRODUCT.price}"/>
                                    <font color="red">
                                    </font>
                                    <img id="blah" src="${requestScope.PRODUCT.img}" width="150px" height="200px"/><br>
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <textarea class="form-control" id="inputDescription" name="txtDescription" <c:if test="${requestScope.PRODUCT.status eq 'Inactive'}">readonly="true"</c:if>>
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputQuantity" value="${requestScope.PRODUCT.quantity}" name="txtQuantity" <c:if test="${requestScope.PRODUCT.status eq 'Inactive'}">readonly="true"</c:if>/>
                                    <font color="red">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="cboStatus" id="inputStatus">
                                        <option <c:if test="${requestScope.PRODUCT.status eq 'Active'}">selected="true"</c:if>>Active</option>
                                        <option <c:if test="${requestScope.PRODUCT.status eq 'Inactive'}">selected="true"</c:if>>Inactive</option>
                                        </select>
                                        <font color="red">
                                        </font>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <c:if test="${applicationScope.listCategories!=null}">
                                            <c:forEach items="${applicationScope.listCategories}" var="cate">
                                                <option value="${cate.id}" <c:if test="${requestScope.PRODUCT.category eq cate.id}">selected="true"</c:if>>${cate.name}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                                    <font color="red">
                        ...
                        <input type="hidden" value="${requestScope.PRODUCT.img}" name="imgURL"/>
                        <input type="hidden" value="${requestScope.PRODUCT.productID}" name="txtID"/>
                    </div>
                    <div class="container">
                        <div class="row">
