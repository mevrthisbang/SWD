                            ...
                            <div class="center">
                                <form action="MainController" method="POST">
                                    <table border="1" class="table table-bordered" style="width: 800px; margin-right: 50px; height: 310px;">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.CART.cart.values()}" var="product">
                                                <tr>
                                                    <td>
                                                        ${product.name}
                                                    </td>
                                                    <td>
                                                        <input type="number" value="${product.quantity}" name="txtQuantity" style="width: 60px;"/><br>
                                                        <font color="red">${product.description}</font>
                                                        <input type="hidden" value="${product.productID}" name="txtID"/>
                                                    </td>
                                                    <td>
                                                        ${product.price}$
                                                    </td>
                                                    <td>
                                                        <div id="total">
                                                            <fmt:formatNumber type="number" maxFractionDigits="3" value="${product.quantity*product.price}"/>$
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" name="chkRemove" value="${product.productID}"/>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
