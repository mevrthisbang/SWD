        ...
        <body>
            ...
            <div class="container" style="margin-top: 50px;">
                <c:if test="${requestScope.listProduct!=null}">
                    <c:if test="${not empty requestScope.listProduct}" var="testEmpty">
                        <div class="center">
                            <form action="MainController" method="POST">
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.listProduct}" var="product">
                                            ...
                                            <tr>
                                                <td>${product.name}</td>
                                                <td>
                                                    <img alt="Food Image" src="${product.img}" width="100px" height="100px"/>
                                                </td>
                                                <td>
                                                    ${product.price}$
                                                </td>
                                                ...
                                                <td>
                                                    <c:if test="${product.status eq 'Active'}">
                                                        <input type="checkbox" id="chkDelete" name="chkCheckDelete" value="${product.productID}"/>
                                                    </c:if>
