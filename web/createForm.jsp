<%-- 
    Document   : createForm
    Created on : Oct 19, 2021, 6:44:21 PM
    Author     : mevrthisbang
--%>
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputName" value="${requestScope.PRODUCT.name}" name="txtName"/>
                                    <font color="red">
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputPrice" value="${requestScope.PRODUCT.price}" name="txtPrice"/>
                                    <font color="red">
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="file" onchange="readURL(this);" accept="image/*" name="imgFood" class="form-control-file" id="inputImg" value="${requestScope.PRODUCT.price}" name="txtPrice"/>
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <textarea class="form-control" id="inputDescription" name="txtDescription">
                        ...
                        <div class="form-row">
                            ...
                            <div class="center">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputQuantity" value="${requestScope.PRODUCT.quantity}" name="txtQuantity"/>
                                    <font color="red">
