                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="rate">
                                                        ...
                                                        <input type="radio" id="star3" name="rate${productInfo.productID}" value="3" />
                                                        <label for="star3" title="text">3 stars</label>
                                                        <input type="radio" id="star2" name="rate${productInfo.productID}" value="2" />
                                                        <label for="star2" title="text">2 stars</label>
                                                        <input type="radio" id="star1" name="rate${productInfo.productID}" value="1" />
                                                        <label for="star1" title="text">1 star</label>
<!--                                                        <input type="hidden" name="rate${productInfo.productID}" value="${rate}"/>-->
                                                    </div><br/><br/><br/>
