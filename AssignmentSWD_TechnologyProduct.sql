...
Cameras: 64 MP, f/1.8, 26mm (wide), 1/1.97", 0.7�m, PDAF | 8 MP, f/2.2, 118� (ultrawide), 1/4.0", 1.12�m | 2 MP, f/2.4, (macro) | 2 MP, f/2.4, (depth)
...
? HDD: QU� KH�CH T�Y CH?N THEO NHU C?U 
...
INSERT [dbo].[PAYMENT] ([id], [name]) VALUES(N'P-1', 'Cash on Delivery')
INSERT [dbo].[PAYMENT] ([id], [name]) VALUES(N'P-2', 'Paypal')
